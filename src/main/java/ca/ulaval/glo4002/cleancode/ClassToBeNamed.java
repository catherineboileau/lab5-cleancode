 ...
 * under the License.
 */
package ca.ulaval.glo4002.cleancode;

import java.util.HashMap;
import java.util.Map;

// Found here (but the name was changed - don't cheat!): https://github.com/mqlight/java-mqlight
public class ClassToBeNamed {
    ...
    public ClassToBeNamed() {}

    public ClassToBeNamed expect(String shortName, String longName, Class<?> type, Object defaultValue) {
